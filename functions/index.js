...
function findBooks(req, res){
    ...
    findBooksAmazon(search_string, res);
...
function findBooksAmazon(search_string, res){
    ...
    request(url, function(error, response, body){
        ...
        bookResults['amazon'] = bookResults_amazon;

        findBooksFlipkart(search_string, res);
...
function findBooksFlipkart(search_string, res){
    ...
    request(url, function(error, response, body) {
        ...
        bookResults['flipkart'] =  bookResults_flipkart;

        findBooksSnapdeal(search_string, res);
...
function findBooksSnapdeal(search_string, res){
    ...
    request(url, function(error, response, body) {
        ...
        bookResults['snapdeal'] = bookResults_snapdeal;

        findBooksSapna(search_string, res);
...
function findBooksSapna(search_string, res){
    ...
    request(url, function(error, response, body) {
        ...
        bookResults['sapna'] = bookResults_sapna;
...
//exports.app1 = functions.https.onRequest((req, res) => {
//    console.log('I am a log entry!');

//    console.log(req.body);

//    var search_string = req.body.book;
